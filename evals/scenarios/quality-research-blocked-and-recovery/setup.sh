...
const files = {
  ...
  ".pm/quality/input-lock.json": "{\"case_id\":\"research-blocked-and-recovery\",\"frozen\":true,\"evidence_sha256\":\"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\"}\n",
  "dependency-contract.md": "The required signed willingness-to-pay source is unavailable. Partial product research is still authorized.\n",
  "contract-check.js": "console.error('signed source unavailable'); process.exitCode = 2;\n",
  ".pm/quality/case-state.json": "{\n  \"workflow\": \"research\",\n  \"case_id\": \"research-blocked-and-recovery\",\n  \"case_type\": \"blocked-and-recovery\",\n  \"state\": \"A required dependency is unavailable; verified facts, assumptions, and a recovery test must remain distinct.\"\n}\n"
};
