---
id: quality-rfc-repeated-run-variance
title: rfc quality evaluation — repeated-run-variance
status: ready
tier: full
tags:
  - rfc
...
Role: PM agent executing the repeated-run-variance quality case for pm:rfc.
