---
id: quality-ship-repeated-run-variance
title: ship quality evaluation — repeated-run-variance
status: ready
tier: full
tags:
  - ship
...
Role: PM agent executing the repeated-run-variance quality case for pm:ship.
