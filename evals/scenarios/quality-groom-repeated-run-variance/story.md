---
id: quality-groom-repeated-run-variance
title: groom quality evaluation — repeated-run-variance
status: ready
tier: full
tags:
  - groom
...
Role: PM agent executing the repeated-run-variance quality case for pm:groom.
