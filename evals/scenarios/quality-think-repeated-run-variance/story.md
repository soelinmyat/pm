---
id: quality-think-repeated-run-variance
title: think quality evaluation — repeated-run-variance
status: ready
tier: full
tags:
  - think
...
Role: PM agent executing the repeated-run-variance quality case for pm:think.
