...
const files = {
  ...
  ".pm/quality/input-lock.json": "{\"case_id\":\"strategy-happy-path\",\"frozen\":true,\"evidence_sha256\":\"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\"}\n",
  ".pm/quality/case-state.json": "{\n  \"workflow\": \"strategy\",\n  \"case_id\": \"strategy-happy-path\",\n  \"case_type\": \"happy-path\",\n  \"state\": \"Complete, approved inputs are available and no known blocker remains.\"\n}\n"
};
