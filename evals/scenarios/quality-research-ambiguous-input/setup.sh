...
const files = {
  ...
  ".pm/quality/input-lock.json": "{\"case_id\":\"research-ambiguous-input\",\"frozen\":true,\"evidence_sha256\":\"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\"}\n",
  "decision-options.md": "Option A: pilot permission-scoped CSV with A. Option B: pilot scheduling with B. Evidence disagrees; choose a reversible test.\n",
  ".pm/quality/case-state.json": "{\n  \"workflow\": \"research\",\n  \"case_id\": \"research-ambiguous-input\",\n  \"case_type\": \"ambiguous-input\",\n  \"state\": \"Two materially different interpretations remain plausible and require an explicit decision.\"\n}\n"
};
