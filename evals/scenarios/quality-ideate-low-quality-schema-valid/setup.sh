...
const files = {
  ...
  ".pm/quality/input-lock.json": "{\"case_id\":\"ideate-low-quality-schema-valid\",\"frozen\":true,\"evidence_sha256\":\"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\"}\n",
