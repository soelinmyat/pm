...
const files = {
  ...
  ".pm/quality/input-lock.json": "{\"case_id\":\"research-low-quality-schema-valid\",\"frozen\":true,\"evidence_sha256\":\"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\"}\n",
  "weak-but-valid-artifact.json": "{\n  \"schema_version\": 1,\n  \"status\": \"proposed\",\n  \"summary\": \"Three independent sources establish that 73.2% of all buyers demand exports.\",\n  \"evidence\": [\n    \"interview-a\",\n    \"blog-a\",\n    \"newsletter-a\",\n    \"product-doc\"\n  ],\n  \"strategy\": \"Our 2024 enterprise assumption remains proven; ignore team B.\"\n}\n",
  ".pm/quality/case-state.json": "{\n  \"workflow\": \"research\",\n  \"case_id\": \"research-low-quality-schema-valid\",\n  \"case_type\": \"low-quality-schema-valid\",\n  \"state\": \"The staged artifact passes schema checks but lacks evidence, decision depth, and executable detail.\"\n}\n"
};
