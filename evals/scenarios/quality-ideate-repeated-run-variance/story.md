---
id: quality-ideate-repeated-run-variance
title: ideate quality evaluation — repeated-run-variance
status: ready
tier: full
tags:
  - ideate
...
Role: PM agent executing the repeated-run-variance quality case for pm:ideate.
