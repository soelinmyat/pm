...
const files = {
  ...
  ".pm/quality/input-lock.json": "{\"case_id\":\"research-repeated-run-variance\",\"frozen\":true,\"evidence_sha256\":\"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\"}\n",
  ".pm/quality/repeat-control.json": "{\"repeats\":3,\"source\":\"frozen\",\"reset_between_runs\":true,\"expectation\":\"concise-correct\"}\n",
  ".pm/quality/case-state.json": "{\n  \"workflow\": \"research\",\n  \"case_id\": \"research-repeated-run-variance\",\n  \"case_type\": \"repeated-run-variance\",\n  \"state\": \"The source snapshot and inputs are frozen for three independent repeats.\"\n}\n"
};
