---
id: quality-strategy-repeated-run-variance
title: strategy quality evaluation — repeated-run-variance
status: ready
tier: full
tags:
  - strategy
...
Role: PM agent executing the repeated-run-variance quality case for pm:strategy.
