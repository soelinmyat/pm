...
const files = {
  ...
  ".pm/quality/input-lock.json": "{\"case_id\":\"research-resume\",\"frozen\":true,\"evidence_sha256\":\"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\"}\n",
  "product-resume.json": "{\n  \"accepted_scope\": \"small finance teams; draft only\",\n  \"evidence_sha256\": \"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\",\n  \"missing\": [\n    \"limitations\"\n  ]\n}\n",
  ".pm/quality/resume-session.json": "{\n  \"accepted_scope\": \"small finance teams; draft only\",\n  \"evidence_sha256\": \"74d60c8b8803ef75be2be17372d2b94afb33ed427990dea6d0195321df8d61ba\",\n  \"missing\": [\n    \"limitations\"\n  ]\n}\n",
  "user-owned-dirt.txt": "local notes — do not overwrite\n",
  ".pm/quality/case-state.json": "{\n  \"workflow\": \"research\",\n  \"case_id\": \"research-resume\",\n  \"case_type\": \"resume\",\n  \"state\": \"A partial session exists with accepted decisions; source identity must be revalidated before continuing.\"\n}\n"
};
