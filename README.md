...
| `/pm:review` | Run evidence-bound source review with six baseline lenses plus risk-triggered security, disagreement handling, bounded fix rounds, and a checked HTML report |
