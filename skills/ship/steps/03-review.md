...
This freezes the target, plans six baseline lenses plus risk-triggered security across available reviewers, validates structured evidence, preserves disagreement, runs bounded fix rounds, and publishes checked JSON, plus HTML when required by the derived presentation policy.
