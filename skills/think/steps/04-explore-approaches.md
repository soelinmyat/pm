...
**Goal:** Give the user genuinely different directions to choose from, so the conversation converges on an approach with eyes open about tradeoffs.
...
Format as a compact table or short sections. Lead with your recommendation if you have one — don't hide your opinion behind false neutrality.
