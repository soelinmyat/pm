...
For UI features, this step produces a **prototype** (sketch / wireframe / mockup) saved to `{pm_dir}/backlog/wireframes/`. The proposal embeds the prototype as a hero figure (per Step 7).
