...
The RFC HTML template (`references/templates/rfc-reference.html`) uses these classes in the Issues section. Any RFC generated by this skill must preserve them.
