...
7. Stop at round 3. Preserve a blocked report and ask for direction if Review-owned blockers or disagreement remain. Never create a new run ID for the same Dev decision version; only explicit direction recorded as a new decision version can open another lineage.
