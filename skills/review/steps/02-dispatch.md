...
5. Save one file per planned worker under `review/results/{worker-id}.json`. Do not repair malformed reviewer JSON by inventing content; re-dispatch that worker once with the validation error.
