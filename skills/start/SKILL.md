...
### Step 3.5: Customization (optional, mention only)
...
Include this as a single line in the bootstrap summary (Step 4 or equivalent): "Create `pm/instructions.md` to customize how PM writes and what it tracks."
