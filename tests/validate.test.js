...
test("PM-170: plugin.config.json has exactly 18 commands (no merge, has features, sync, note, ideate, rfc, simplify, list, and review)", () => {
  ...
  assert.ok(config.commands.includes("features"), "features command must be present");
