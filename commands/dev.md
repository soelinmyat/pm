...
Explicitly assessed low-risk XS/S web UI work combines desktop, narrow, and keyboard visual checks into current browser QA. Mobile, mixed-platform, consequential, or uncertain UI changes retain standalone design critique. Tests, source review, authorization, CI, and deployment checks remain mandatory as routed.
