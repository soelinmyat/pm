...
- Stage all modified and deleted tracked files relevant to the plugin (skills/, commands/, hooks/, scripts/, personas/, references/, tools/, .claude-plugin/, .codex-plugin/, .claude/)
